...
import { FiBriefcase,FiTrash2,FiEdit,FiPlusCircle } from "react-icons/fi";
import { getExperiences,deleteExperience } from '../../../apis/PostApi';
...
const Experience = () => {
    ...
    const handleDeleteTrue = async () =>{
        await deleteExperience(modal.id);
        handleClose();
        fetchExperiences()
}
    ...
    return (
        <div className="contentBody"> 
            ...
            <div className="component_title">
                ...
                <Button variant="primary" href="/admin/add_experience"><FiPlusCircle className="me-2"/> Experience</Button>
                </Container>
            </div>
            <Container fluid> 
                {experiences &&
                        ...
                        {experiences.map((experience,index)=>(
                          ...
                          >
                            <div className="d-flex justify-content-end pb-3">
                                <Button className="m-1 d-flex align-items-center justify-content-center"  variant="outline-secondary"><FiEdit className="me-2" size={14}/> Edit</Button>
                                <Button className="m-1 d-flex align-items-center justify-content-center"variant="danger"onClick={() => handleDelete(experience._id,experience.title)}
