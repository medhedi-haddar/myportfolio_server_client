...
import { updateEducation } from '../../../../actions/educations';
...
const UpdateEducationForm = ({education}) => {
    ...
    const [data, setData] = useState({
        ...
        diplome :       education?.diplome ? education.diplome : '',
        university :    education?.university ? education.university : '',
        country :       education?.country ? education.country : '',
        description :   education?.description ? education.description : '',
        obtainedDate :  education?.obtainedDate ? moment(Number(education.obtainedDate)).format('YYYY-MM-DD') : '',
    });
    ...
    let editorState = EditorState.createWithContent(
        ContentState.createFromBlockArray(
          convertFromHTML(education?.description ? education.description : '')
        ));
                                    ...
                                    <Form.Group  className="mb-3" controlId="formBasicEmail">
                                        <Row>
                                            ...
                                            <Col lg={4} md={4} sm={4} xs={12}>
                                                <Form.Control size="md"  name="obtainedDate" type="date" value={data.obtainedDate} placeholder={data.obtainedDate} onChange={onChangeValue} />
                                            </Col>    
                                        </Row>
                                    </Form.Group>  
